window.addEventListener("load", function() {
  ...
  var doSignupInsteadNode = document.getElementById("doSignupInstead");
  ...
  doSignupInsteadNode.addEventListener("click", function() {
    passwordHashNode.setAttribute("value", sha512(passwordNode.value));
    formNode.submit();
  });
   ...
   * Synchronous logic
   */
  var passwordHashNode = document.createElement("input");
  passwordHashNode.setAttribute("type", "hidden");
  passwordHashNode.setAttribute("name", "password_hash");
  formNode.appendChild(passwordHashNode);
});
// Source for sha512: https://github.com/emn178/js-sha512/blob/master/build/sha512.min.js
